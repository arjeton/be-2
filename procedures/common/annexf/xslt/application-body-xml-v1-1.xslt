  ...
  <xsl:template name="body">
    ...
    <xsl:for-each select="$submission/array[@key='attachments']">
      <xsl:choose>
        ...
        <xsl:when test="map[string[@key='attachmentType']='TRANSLATION_DESCRIPTION']">
          <xsl:call-template name="description">
            <xsl:with-param name="object" select="map[string[@key='attachmentType']='TRANSLATION_DESCRIPTION']"/>
          </xsl:call-template>
        </xsl:when>
        <xsl:otherwise>
          <xsl:choose>
            <xsl:when test="((map[string[@key='attachmentType']='COMBINED']) and (map/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_DESCRIPTION']))">
      ...
      <xsl:choose>
        <xsl:when test="map[string[@key='attachmentType']='TRANSLATION_CLAIMS']">
          <xsl:call-template name="claims">
            <xsl:with-param name="object" select="map[string[@key='attachmentType']='TRANSLATION_CLAIMS']"/>
          </xsl:call-template>
        </xsl:when>
        <xsl:otherwise>

          <xsl:choose>
            <xsl:when test="((map[string[@key='attachmentType']='COMBINED']) and (map/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_CLAIMS']))">
              <xsl:call-template name="combined">
                <xsl:with-param name="object" select="map[string[@key='attachmentType']='COMBINED']"/>
      ...
      <xsl:choose>
        <xsl:when test="map[string[@key='attachmentType']='TRANSLATION_ABSTRACT']">
          <xsl:call-template name="abstract">
            <xsl:with-param name="object" select="map[string[@key='attachmentType']='TRANSLATION_ABSTRACT']"/>
          </xsl:call-template>
        </xsl:when>
        <xsl:otherwise>

          <xsl:choose>
            <xsl:when test="((map[string[@key='attachmentType']='COMBINED']) and (map/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_ABSTRACT']))">
              <xsl:call-template name="combined">
                <xsl:with-param name="object" select="map[string[@key='attachmentType']='COMBINED']"/>
      ...
      <xsl:choose>
        <xsl:when test="map[string[@key='attachmentType']='TRANSLATION_DRAWINGS']">
          <xsl:call-template name="drawings">
            <xsl:with-param name="object" select="map[string[@key='attachmentType']='TRANSLATION_DRAWINGS']"/>
          </xsl:call-template>
        </xsl:when>
        <xsl:otherwise>

          <xsl:choose>
            <xsl:when test="((map[string[@key='attachmentType']='COMBINED']) and (map/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_DRAWINGS']))">
              <xsl:call-template name="combined">
                <xsl:with-param name="object" select="map[string[@key='attachmentType']='COMBINED']"/>
  ...
  <xsl:template name="combined">
    ...
    <xsl:if test="$attachmentType='description'">
      <xsl:call-template name="combinedScope" >
        <xsl:with-param name="object" select="$object/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_DESCRIPTION']"/>
        <xsl:with-param name="id">DESC1</xsl:with-param>
    ...
    <xsl:if test="$attachmentType='claims'">
      <xsl:call-template name="combinedScope" >
        <xsl:with-param name="object" select="$object/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_CLAIMS']"/>
        <xsl:with-param name="id">CLMS1</xsl:with-param>
        <xsl:with-param name="attachmentType" select="$attachmentType"/>
        <xsl:with-param name="type" select="substring-after($object/string[@key='mimeType'], '/')" />
        <xsl:with-param name="fileName" select="$object/string[@key='fileName']" />
    ...
    <xsl:if test="$attachmentType='abstract'">
      <xsl:call-template name="combinedScope" >
        <xsl:with-param name="object" select="$object/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_ABSTRACT']"/>
        <xsl:with-param name="id">ABST1</xsl:with-param>
        <xsl:with-param name="attachmentType" select="$attachmentType"/>
        <xsl:with-param name="type" select="substring-after($object/string[@key='mimeType'], '/')" />
        <xsl:with-param name="fileName" select="$object/string[@key='fileName']" />
    ...
    <xsl:if test="$attachmentType='drawings'">
      <xsl:call-template name="combinedScope" >
        <xsl:with-param name="object" select="$object/array[@key='combinedFileTypeScopes']/map[string[@key='type']='TRANSLATION_DRAWINGS']"/>
        <xsl:with-param name="id">DRAW1</xsl:with-param>
        <xsl:with-param name="attachmentType" select="$attachmentType"/>
        <xsl:with-param name="type" select="substring-after($object/string[@key='mimeType'], '/')" />
        <xsl:with-param name="fileName" select="$object/string[@key='fileName']" />
