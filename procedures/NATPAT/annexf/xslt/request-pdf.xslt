<xsl:stylesheet
    ...
    <xsl:template name="html">
        <html>
            <head>
                ...
                <title>
                    <xsl:choose>
                        <xsl:when test="$submissionXml/map[@key='basicFilingInfo']/string[@key='applicationType'] = 'DIVISIONAL'">
                            <xsl:value-of select="ext:translate('request.pdf.main.divisional.title', $pdfLanguage, $configVersion)" />
                        </xsl:when>
                        <xsl:when test="$submissionXml/map[@key='basicFilingInfo']/string[@key='applicationType'] = 'EUROPEAN_CONVERSION'">
                            <xsl:value-of select="ext:translate('request.pdf.conversion.main.title', $pdfLanguage, $configVersion)" />
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <tr>
                    ...
                    <td>
                        <div class="title">
                            <h2>
                                <xsl:choose>
                                    <xsl:when test="map[@key='basicFilingInfo']/string[@key='applicationType'] = 'DIVISIONAL'">
                                        <xsl:value-of select="ext:translate('request.pdf.divisional.main.title', $pdfLanguage, $configVersion)" />
                                    </xsl:when>
                                    <xsl:when test="map[@key='basicFilingInfo']/string[@key='applicationType'] = 'EUROPEAN_CONVERSION'">
                                        <xsl:value-of select="ext:translate('request.pdf.conversion.main.title', $pdfLanguage, $configVersion)" />
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:value-of select="ext:translate('request.pdf.main.title', $pdfLanguage, $configVersion)" />
    ...
    <xsl:template name="basicFilingInfo">
        ...
        <table class="content">
            <tr>
                ...
                <td>
                    <xsl:call-template name="fieldWithLabel">
                        <xsl:with-param name="label" select="ext:translate('request.pdf.user-reference', $pdfLanguage, $configVersion)"/>
                        <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/string[@key='userReference']"/>
                    </xsl:call-template>
                    <div class="subSectionDivider"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <h2>
                        <xsl:value-of select="ext:translate('request.pdf.title.invention', $pdfLanguage, $configVersion)"/>
                    </h2>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <xsl:call-template name="areaWithLabel">
                        <xsl:with-param name="label" select="ext:translate('basic-filing.title-of-invention-first-language', $pdfLanguage, $configVersion)"/>
                        <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/map[@key='titlesOfInventionContainer']/string[@key='titleOfInventionFirstLanguage']"/>
                    </xsl:call-template>

                    <xsl:call-template name="areaWithLabel">
                        <xsl:with-param name="label" select="ext:translate('basic-filing.title-of-invention-second-language', $pdfLanguage, $configVersion)"/>
                        <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/map[@key='titlesOfInventionContainer']/string[@key='titleOfInventionSecondLanguage']"/>
                    </xsl:call-template>
                    <div class="subSectionDivider"/>
                    <div class="subSectionDivider"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <h3>
                        <xsl:value-of select="ext:translate('basic-filing.application-type', $pdfLanguage, $configVersion)"/>
                    </h3>
                </td>
            </tr>

            <xsl:choose>
                <xsl:when test="map[@key='basicFilingInfo']/string[@key='applicationType'] = 'NATIONAL_PATENT'">
                    <tr>
                        <td class="referenceCell"></td>
                        <td>
                            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.national.main.title', $pdfLanguage, $configVersion)" />
                ...
                <xsl:when test="map[@key='basicFilingInfo']/string[@key='applicationType'] = 'DIVISIONAL'">
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.divisional.main.title', $pdfLanguage, $configVersion)" />
                                <xsl:with-param name="checkboxValue" select="true()" />
                            </xsl:call-template>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('basic-filing.divisional-number', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/string[@key='divisionalNumber']"/>
                            </xsl:call-template>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('basic-filing.divisional-filing-date', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/string[@key='divisionalFilingDate']"/>
                            </xsl:call-template>
                        </td>
                    </tr>
                </xsl:when>
                <xsl:when test="map[@key='basicFilingInfo']/string[@key='applicationType'] = 'EUROPEAN_CONVERSION'">
                    ...
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.conversion.main.title', $pdfLanguage, $configVersion)" />
                                <xsl:with-param name="checkboxValue" select="true()" />
                            </xsl:call-template>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('validation.property.ep-number', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/string[@key='epNumber']"/>
                            </xsl:call-template>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('basic-filing.ep-filing-date', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/string[@key='epFilingDate']"/>
                            </xsl:call-template>
                        </td>
                    </tr>
                </xsl:when>
                <xsl:when test="map[@key='basicFilingInfo']/string[@key='applicationType'] = 'MODALITIES_CHANGE'">
                    <div class="divider"/>
                    <tr>
                        <td class="referenceCell"></td>
                        <td>
                            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                                <xsl:with-param name="label" select="ext:translate('basic-filing.application-type.modalities-change', $pdfLanguage, $configVersion)" />
                                <xsl:with-param name="checkboxValue" select="true()" />
                            </xsl:call-template>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('basic-filing.um-application-number', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/string[@key='modNumber']"/>
                            </xsl:call-template>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('basic-filing.ep-filing-date', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="map[@key='basicFilingInfo']/string[@key='modFilingDate']"/>
                            </xsl:call-template>
                        </td>
                    </tr>
                </xsl:when>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="subSectionDivider"/>
                    <h3>
                        <xsl:value-of select="ext:translate('basic-filing.type-of-search-report', $pdfLanguage, $configVersion)"/>
                    </h3>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <xsl:call-template name="fieldWithLabel">
                        <xsl:with-param name="fieldText" select="ext:translate(concat('request.pdf.basic-filing.type-of-search-report','.', current()/map[@key='basicFilingInfo']/string[@key='typeOfSearchReportContainer']), $pdfLanguage, $configVersion)"/>
                    </xsl:call-template>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                        <xsl:with-param name="label" select="ext:translate('basic-filing.other', $pdfLanguage, $configVersion)" />
                        <xsl:with-param name="checkboxValue" select="map[@key='basicFilingInfo']/boolean[@key='other']" />
                    </xsl:call-template>
                    <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                        <xsl:with-param name="label" select="ext:translate('basic-filing.gdprAcceptance-without-link', $pdfLanguage, $configVersion)" />
                        <xsl:with-param name="checkboxValue" select="map[@key='basicFilingInfo']/boolean[@key='dataProtectionAcceptance']" />
                    </xsl:call-template>
                </td>
            </tr>
        </table>
    ...
    <xsl:template name="declaration">
        ...
        <xsl:if test="map[@key='declaration']/array[@key='filingByReference']">
            <xsl:call-template name="filingByReference">
                <xsl:with-param name="filingByReference" select="map[@key='declaration']/array[@key='filingByReference']" />
            </xsl:call-template>
        </xsl:if>
        <xsl:if test="map[@key='declaration']/array[@key='exhibitions']">
            <xsl:call-template name="exhibitions">
                <xsl:with-param name="exhibitions" select="map[@key='declaration']/array[@key='exhibitions']" />
            </xsl:call-template>
        </xsl:if>
    </xsl:template>
    
    <xsl:template name="seqBio">
        <div style="page-break-inside: avoid;">
            <table style="page-break-inside: avoid;" class="content">
                <tr>
                    ...
                    <td>
                        <h1>
                            <xsl:value-of select="ext:translate('request.pdf.seqbio.title', $pdfLanguage, $configVersion)"/>
                        </h1>
                        <xsl:if test="not(array[@key='attachments']/map/string[@key='attachmentType'] = ('SEQ_LIST') or map[@key='seqlBio']/array[@key='biologicalInfos'])" >
            ...
            <xsl:call-template name="seqList"/>
            
            <div class="sectionDivider"/>
            
            <xsl:call-template name="bioInfo"/>
        </div>
    </xsl:template>
    
    <xsl:template name="seqList">
        <xsl:if test="array[@key='attachments']/map/string[@key='attachmentType'] = ('SEQ_LIST')">
            <table style="page-break-inside: avoid;" class="content">
                <tr>
                    <td class="referenceCell"/>
                    <td>
                        <h3>
                            <xsl:value-of select="ext:translate('request.pdf.seqlist.title', $pdfLanguage, $configVersion)"/>
                        </h3>
                    </td>
                </tr>
            </table>  
            
            <div style="page-break-inside: avoid;" class="attachmentsTable">
                <table>
                    <thead>
                        <tr>
                            <th>
                    ...
                    <tbody>
                        <xsl:if test="not(array[@key='attachments']/map/string[@key='attachmentType'] = ('SEQ_LIST'))">
                            <tr>
                        ...
                        <xsl:for-each select="array[@key='attachments']/map">
                            <xsl:if test="current()/string[@key='attachmentType'] = ('SEQ_LIST')">
                                <tr>
                                    <td>
                                        <xsl:value-of select="ext:translate('request.pdf.attachment.type.seqlist', $pdfLanguage, $configVersion)" />
                                    </td>
                                    <td>
    ...
    <xsl:template name="bioInfo">
        <xsl:if test="map[@key='seqlBio']/array[@key='biologicalInfos']">
            
            <xsl:variable name="biologicalInfos" select="map[@key='seqlBio']/array[@key='biologicalInfos']" />
            ...
            <table style="page-break-inside: avoid;" class="content">
                <tr>
                    ...
                    <td>
                        ...
                        <xsl:for-each select="$biologicalInfos/map">
                            <xsl:variable name="bioMaterial" select="current()/map[@key='bioMaterial']" />
                            
                            <h3>
                                <xsl:value-of select="concat(ext:translate('request.pdf.bioinfo.title', $pdfLanguage, $configVersion), ' ', current()/number[@key='sequenceNumber'])"/>
                            </h3>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.bioinfo.country', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="ext:translate_enum($bioMaterial/string[@key='country'], 'procedures-common-form-geo.jsonschema-definitions-country', $pdfLanguage, $configVersion, $procedure)"/>
                            </xsl:call-template>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.bioinfo.institution', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="ext:translate_enum($bioMaterial/string[@key='institution'], 'institution', $pdfLanguage, $configVersion, $procedure)"/>
                            </xsl:call-template>
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.bioinfo.accession', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="ext:translate_enum($bioMaterial/string[@key='accession'], 'procedures-common-form-geo.jsonschema-definitions-country', $pdfLanguage, $configVersion, $procedure)"/>
                            </xsl:call-template>
                            <xsl:call-template name="nonEmptyFieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.bioinfo.date', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="format-date($bioMaterial/string[@key='date'], '[D01]/[M01]/[Y]')"/>
                            </xsl:call-template>
                            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.bioinfo.restricted', $pdfLanguage, $configVersion)" />
                                <xsl:with-param name="checkboxValue" select="$bioMaterial/boolean[@key='restricted']" />
                            </xsl:call-template>
                            
                            <xsl:if test="$bioMaterial/array[@key='attachments']/map">
                                <div class="subSectionDivider"/>
                                <table style="page-break-inside: avoid;"  class="bioAttachmentsTable">
                                    <thead>
                                        <tr>
                                            <th>
                                                <xsl:value-of select="ext:translate('request.pdf.attachment.document.type', $pdfLanguage, $configVersion)" />
                                    ...
                                    <tbody>
                                        <xsl:if test="not($bioMaterial/array[@key='attachments']/map/string[@key='attachmentType'] = ('BIO_MATERIAL'))">
                                            <tr>
                                                <td><xsl:text>&#160;</xsl:text></td>
                                                <td><xsl:text>&#160;</xsl:text></td>
                                                <td><xsl:text>&#160;</xsl:text></td>
                                        ...
                                        <xsl:for-each select="$bioMaterial/array[@key='attachments']/map">
                                            <xsl:if test="current()/string[@key='attachmentType'] = ('BIO_MATERIAL')">
                                                <tr>
                                                    <td>
                                                        <xsl:value-of select="ext:translate('request.pdf.attachment.type.bioinfo', $pdfLanguage, $configVersion)" />
                                                    </td>
                                                    <td>
                                                        <xsl:value-of select="current()/string[@key='originalFileName']" />
                                                    </td>
            ...
            <table class="content">
                <tr>
                    ...
                    <td>
                        ...
                        <xsl:call-template name="landlineDetails">
                        ...
                        <xsl:call-template name="powerRepresentation">
                            <xsl:with-param name="powerOfRepresentationDetails" select="current()/map[@key='powerOfRepresentationDetails']"/>
                        </xsl:call-template>
                    </td>
                </tr>
            </table>
                    ...
                    <td>
                        ...
                        <xsl:call-template name="fieldWithLabel">
                            ...
                            <xsl:with-param name="fieldText" select="ext:translate_enum(
                                current()/map[@key='contactDetails']/map[@key='residenceAddress']/string[@key='country'],
                        ...
                        <xsl:call-template name="nonEmptyFieldWithLabel">
                            ...
                            <xsl:with-param name="fieldText" select="current()/map[@key='contactDetails']/map[@key='residenceAddress']/string[@key='city']"/>
                        </xsl:call-template>

                        <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                            <xsl:with-param name="checkboxValue" select="current()/boolean[@key='isWaiver']" />
                            <xsl:with-param name="label" select="ext:translate('parties.natural-person.waiver', $pdfLanguage, $configVersion)" />
                        </xsl:call-template>
                    </td>
                </tr>
            </table>
    ...
    <xsl:template name="contactPersons">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <xsl:for-each select="$contactPersons/map">
                        <h3>
                        ...
                        <xsl:call-template name="fieldWithLabel">
                            ...
                            <xsl:with-param name="fieldText" select=" current()/map[@key='personalInformation']/string[@key='lastName']"/>
                        </xsl:call-template>

                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="'First Name'"/>
                            <xsl:with-param name="fieldText" select="current()/map[@key='personalInformation']/string[@key='firstName']"/>
                        </xsl:call-template>

                        <xsl:if test="current()/map[@key='personalInformation']/string[@key='representativeCode'] != ''">
                          <xsl:call-template name="fieldWithLabel">
                              <xsl:with-param name="label" select="'Representative Code'"/>
                              <xsl:with-param name="fieldText" select=" current()/map[@key='personalInformation']/string[@key='representativeCode']"/>
                          </xsl:call-template>
                        </xsl:if>
    ...
    <xsl:template name="priorities">
        ...
        <table class="content">
            <tr>
                <td class="referenceCell" style="page-break-inside: avoid;"/>
                <td>
                    <xsl:for-each select="$priorities/map">
                        <h3>
                            <xsl:value-of select="concat(ext:translate('request.pdf.priority', $pdfLanguage, $configVersion), ' ', current()/number[@key='sequenceNumber'])"/>
                        </h3>
                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.type.of.office', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="ext:translate_enum(current()/string[@key='officeType'], 'procedures-common-form-geo.jsonschema-definitions-country', $pdfLanguage, $configVersion, $procedure)"/>
                        </xsl:call-template>
                        <xsl:call-template name="fieldWithLabelAndNumber">
                            <xsl:with-param name="num" select="33"/>
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.office', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="ext:translate_enum(current()/string[@key='office'], 'priorityOffice', $pdfLanguage, $configVersion, $procedure)"/>
                        </xsl:call-template>
                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.kind.of.applications', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="ext:translate_enum(current()/string[@key='applicationKind'], 'procedures-common-form-geo.jsonschema-definitions-country', $pdfLanguage, $configVersion, $procedure)"/>
                        </xsl:call-template>
                        <xsl:call-template name="fieldWithLabelAndNumber">
                            <xsl:with-param name="num" select="31"/>
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.application.number', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="current()/string[@key='applicationNumber']"/>
                        </xsl:call-template>
                        <xsl:call-template name="fieldWithLabelAndNumber">
                            <xsl:with-param name="num" select="32"/>
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.filling.date', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="current()/string[@key='filingDate']"/>
                        </xsl:call-template>
                        <xsl:call-template name="checkBoxWithLabel">
                            <xsl:with-param name="label" select="ext:translate('declaration.priority.request-for-retrieval-of-priority-from-DAS', $pdfLanguage, $configVersion)" />
                            <xsl:with-param name="checkboxValue" select="current()/map[@key='dasCode']/boolean[@key='checkbox']" />
                        </xsl:call-template>
                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.das.code', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="current()/map[@key='dasCode']/string[@key='dasCodeValue']"/>
                        </xsl:call-template>
                      </xsl:for-each>
                </td>
            </tr>
    ...
    <xsl:template name="filingByReference">
        <xsl:param name="filingByReference" />
        <table class="content">
            <tr>
                <td class="referenceCell" style="page-break-inside: avoid;"/>
                <td>
                    <xsl:for-each select="$filingByReference/map">
                        <h3>
                            <xsl:value-of select="concat(ext:translate('declaration.filling.declarations.new', $pdfLanguage, $configVersion), ' ', current()/number[@key='sequenceNumber'])"/>
                        </h3>
                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.type.of.office', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="ext:translate_enum(current()/string[@key='officeType'], 'procedures-common-form-geo.jsonschema-definitions-country', $pdfLanguage, $configVersion, $procedure)"/>
                        ...
                        <xsl:if test="current()/string[@key='applicationNumber'] != ''" >
                            <xsl:call-template name="fieldWithLabel">
                                <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.application.number', $pdfLanguage, $configVersion)"/>
                                <xsl:with-param name="fieldText" select="current()/string[@key='applicationNumber']"/>
                            </xsl:call-template>
                        ...
                        <xsl:call-template name="checkBoxWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.description', $pdfLanguage, $configVersion)" />
                            <xsl:with-param name="checkboxValue" select="current()/string[@key='description']" />
                        </xsl:call-template>
                    </xsl:for-each>
                </td>
            </tr>
    ...
    <xsl:template name="exhibitions">
        <xsl:param name="exhibitions" />

        <table class="content">
            <tr>
                <td class="referenceCell" style="page-break-inside: avoid;"/>
                <td>
                    <xsl:for-each select="$exhibitions/map">
                        <h3>
                            <xsl:value-of select="concat(ext:translate('request.pdf.declarations.exhibition.header', $pdfLanguage, $configVersion), current()/number[@key='sequenceNumber'])" />
                        </h3>
                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.exhibition', $pdfLanguage, $configVersion)" />
                            <xsl:with-param name="fieldText" select="ext:translate_enum(current()/string[@key='internationalExhibition'], 'internationalExhibition', $pdfLanguage, $configVersion, $procedure)"/>
                        </xsl:call-template>
                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.exhibition.city', $pdfLanguage, $configVersion)" />
                            <xsl:with-param name="fieldText" select="ext:translate_enum(current()/string[@key='city'], 'internationalExhibitionCities', $pdfLanguage, $configVersion, $procedure)"/>
                        </xsl:call-template>
                        <xsl:call-template name="fieldWithLabel">
                            <xsl:with-param name="label" select="ext:translate('request.pdf.declarations.exhibition.date', $pdfLanguage, $configVersion)"/>
                            <xsl:with-param name="fieldText" select="format-date(current()/string[@key='exhibitionDate'], '[D01]/[M01]/[Y]')"/>
    ...
    <xsl:template name="parties">
        ...
        <xsl:if test="map[@key='parties']/array[@key='contactPersons']" >
          <div class="subSectionDivider"/>

          <xsl:call-template name="contactPersons">
              <xsl:with-param name="contactPersons" select="map[@key='parties']/array[@key='contactPersons']"/>
          </xsl:call-template>
        </xsl:if>
        ...
        <table class="content">
            <tr>
                ...
                <td>
                    ...
                    <span class="input">
                        <xsl:choose>
                            <xsl:when test="array[@key='attachments']/map/string[@key='attachmentType'] = 'CLAIMS'">
                                <xsl:value-of select="array[@key='attachments']/map/number[@key='numberOfClaims']" />
                            </xsl:when>
                            <xsl:when test="(array[@key='attachments']/map/string[@key='attachmentType'] = ('COMBINED')) ">
                                <xsl:for-each select="array[@key='attachments']/map/array[@key='combinedFileTypeScopes']/map">
                        ...
                        <xsl:when test="$fees/map[@key='feesSelection']/array[@key='selectedFees'] != ''">
                            <xsl:for-each select="$fees/map[@key='feesSelection']/array[@key='selectedFees']/map">
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="concat('EUR ', format-number(current()/number[@key='price'], '#.###,00', 'dec'))" />
                                    </td>
                                    <td>
                                    ...
                                    <td class="tableCellRight">
                                        <xsl:value-of select="concat('EUR ', format-number(current()/number[@key='subtotal'], '#.###,00', 'dec'))" />
                                    </td>
                                </tr>
                            </xsl:for-each>
                            <tr>
                                <td colspan="6" class="tableCellBottomRight">
                                    <xsl:choose>
                                        <xsl:when test="$fees/map[@key='feesSelection']/number[@key='total'] != ''">
                                            <xsl:value-of select="concat(ext:translate('request.pdf.total', $pdfLanguage, $configVersion),' EUR ', format-number($fees/map[@key='feesSelection']/number[@key='total'], '#.###,00', 'dec'))" />
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <xsl:text>&#160;</xsl:text>
                                        </xsl:otherwise>
        ...
        <div style="page-break-inside: avoid;">
            ...
            <div class="attachmentsTable">
                <table>
                    ...
                    <tbody>
                        <xsl:if test="not($attachments/map/string[@key='attachmentType'] = ('DESCRIPTION', 'CLAIMS', 'ABSTRACT', 'DRAWINGS', 'COMBINED', 'PRE-CONVERSION'))">
                            <tr>
                                <td><xsl:text>&#160;</xsl:text></td>
                                <td><xsl:text>&#160;</xsl:text></td>
                                <td><xsl:text>&#160;</xsl:text></td>
                        ...
                        <xsl:for-each select="$attachments/map">
                            <xsl:if test="current()/string[@key='attachmentType'] = ('DESCRIPTION', 'CLAIMS', 'ABSTRACT', 'DRAWINGS', 'COMBINED', 'PRE-CONVERSION')">
                                <tr>
                                    <td>
        ...
        <div style="page-break-inside: avoid;">
            ...
            <div class="attachmentsTable">
                <table>
                    ...
                    <tbody>
                        <xsl:if test="not($attachments/map/string[@key='attachmentType'] = ('GENERAL', 'SPECIFIC', 'ELECTRONIC_PRIORITY', 'TRANSLATIONS_OF_PRIORITY_DOCUMENTS', 'TRANSLATIONS_OF_TECHNICAL_DOCUMENTS',
                                'INVENTOR_WAIVER', 'EXHIBITION', 'INVENTORSHIP', 'SEARCH_REPORT', 'POWER_OF_ATTORNEY', 'PROOF_OF_PAYMENT', 'OTHER', 'POWER_OF_REPRESENTATION', 'POWER_OF_REPRESENTATION'))">
                            <tr>
                                <td><xsl:text>&#160;</xsl:text></td>
                                <td><xsl:text>&#160;</xsl:text></td>
                                <td><xsl:text>&#160;</xsl:text></td>
                        ...
                        <xsl:for-each select="$attachments/map">
                            <xsl:if test="current()/string[@key='attachmentType'] = ('GENERAL', 'SPECIFIC', 'ELECTRONIC_PRIORITY', 'TRANSLATIONS_OF_PRIORITY_DOCUMENTS', 'TRANSLATIONS_OF_TECHNICAL_DOCUMENTS',
                                'INVENTOR_WAIVER', 'EXHIBITION', 'INVENTORSHIP', 'SEARCH_REPORT', 'POWER_OF_ATTORNEY', 'PROOF_OF_PAYMENT', 'OTHER', 'POWER_OF_REPRESENTATION', 'POWER_OF_REPRESENTATION')">
                                <tr>
                                    <td>
    ...
    <xsl:template name="applicant">
        ...
        <div class="container">
            ...
            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                <xsl:with-param name="checkboxValue" select="$applicant/map[@key='contactDetails']/boolean[@key='differentCorrespondenceAddress']" />
                <xsl:with-param name="label" select="ext:translate('request.pdf.different.address.correspondence', $pdfLanguage, $configVersion)" />
            </xsl:call-template>
            
            <xsl:if test="$applicant/map[@key='contactDetails']/boolean[@key='differentCorrespondenceAddress'] = true()">
                <xsl:call-template name="address">
                    <xsl:with-param name="addressFields" select="current()/map[@key='contactDetails']/map[@key='correspondenceAddress']"/>
                </xsl:call-template>
            </xsl:if>
    ...
    <xsl:template name="landlineDetails">
    ...
    <xsl:template name="powerRepresentation">
        <xsl:param name="powerOfRepresentationDetails"/>

        <xsl:variable name="isPowerRepresentationAttached" select="$powerOfRepresentationDetails/boolean[@key='isPowerRepresentationAttached']" />
        <xsl:variable name="isGeneralAuthorisationGranted" select="$powerOfRepresentationDetails/boolean[@key='isGeneralAuthorisationGranted']" />
            ...
            <div style="page-break-inside: avoid;">
                ...
                <xsl:if test="$isGeneralAuthorisationGranted = true()">
                    <xsl:call-template name="nonEmptyFieldWithLabel">
                        ...
                        <xsl:with-param name="fieldText" select="$powerOfRepresentationDetails/string[@key='generalAuthorisation']"/>
                        <xsl:with-param name="customFieldClass" select="'input-medium'" />
                    </xsl:call-template>
                </xsl:if>
            </div>
    ...
    <xsl:template name="declarationOfRights">
        ...
        <xsl:if test="$declarationOfRightsSection">
            ...
            <label class="label-light">
                <xsl:value-of select="ext:translate('request.pdf.rights.acquired.by', $pdfLanguage, $configVersion)" />
            </label>
    ...
    <xsl:template name="address">
        ...
        <xsl:call-template name="nonEmptyFieldWithLabel">
            ...
            <xsl:with-param name="fieldText" select="ext:translate_enum(
                    ...
                    concat('procedures-common-form-geo.jsonschema-definitions-region', $addressFields/string[@key='country']),
                    $pdfLanguage,
                    $configVersion,
                    $procedure)"/>
        </xsl:call-template>
    ...
    <xsl:template name="communicationLineAddress">
        ...
        <xsl:variable name="region" select="ext:translate_enum(
                $addressFields/string[@key='region'],
                'procedures-common-form-geo.jsonschema-definitions-regionES',
                $pdfLanguage,
                $configVersion,
                $procedure)" />
