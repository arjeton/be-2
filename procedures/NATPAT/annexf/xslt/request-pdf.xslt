<xsl:stylesheet
    ...
    <xsl:template name="applicant">
        ...
        <div class="container">
            ...
            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                <xsl:with-param name="checkboxValue" select="$applicant/map[@key='additionalDetails']/boolean[@key='isInventor']" />
                <xsl:with-param name="label" select="ext:translate('request.pdf.applicant.is.inventor', $pdfLanguage, $configVersion)" />
            </xsl:call-template>

            <xsl:call-template name="nonSelectedCheckBoxWithLabel">
                <xsl:with-param name="checkboxValue" select="$applicant/map[@key='additionalDetails']/boolean[@key='waiver']" />
                <xsl:with-param name="label" select="ext:translate('parties.natural-person.waiver', $pdfLanguage, $configVersion)" />
            </xsl:call-template>
        </div>
